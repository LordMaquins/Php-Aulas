     ...
     <div class="lista">
      <div class="item">
        <div class="container">
          ...
          <a href='http://url-destino'> <img class="arredondado" src="images/flash_ver3.jpg" class="img-fluid" alt="Responsive image"> </a>
        </div>
      </div>
      <div class="item ">
      ...
      <div class="item">
        <a href='http://url-destino'><img class="arredondado" src="images/evil_dead_rise_xlg.jpg" class="img-fluid"
            alt="Responsive image"></a>
        <h2>A morte do demonio</h2>
      </div>
      <div class="item">
        <a href='http://url-destino'><img class="arredondado" src="images/guillermo_del_toros_pinocchio_ver2_xxlg.jpg" class="img-fluid"
            alt="Responsive image"></a>
        <h2>Pinocchio: Guilherme Del Toro</h2>
