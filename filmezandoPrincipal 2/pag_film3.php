...
<?php
$filmes = json_decode(file_get_contents('filmes3.json'), true);
?>
<?php foreach ($filmes as $filme): ?>
  ...
  <div class="movie-container">
    ...
    <div class="item2 ">
          ...
          <img src="images/oppenheimer_ver3_xlg.jpg" alt="Cartaz do Filme">
      </div>
</div>
</div>
...
<div class="texto-centralizado">
      <div class="movie-details">
          ...
          <p>Link trailer:<a href='https://youtu.be/A6LqEoh8lMA'>https://youtu.be/A6LqEoh8lMA</p></a>
