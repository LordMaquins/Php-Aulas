...
<?php
$filmes = json_decode(file_get_contents('filmes5.json'), true);
?>
<?php foreach ($filmes as $filme): ?>
  ...
  <div class="movie-container">
    ...
    <div class="item2 ">
          ...
          <img src="images/indiana jones.jpg" alt="Cartaz do Filme">
      </div>
</div>
</div>
...
<div class="texto-centralizado">
      <div class="movie-details">
          ...
          <p>Link trailer:<a href='https://youtu.be/LsZb0RE-ZfE'>https://youtu.be/LsZb0RE-ZfE</p></a>
