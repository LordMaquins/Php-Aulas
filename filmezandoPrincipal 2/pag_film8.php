...
<?php
$filmes = json_decode(file_get_contents('filmes8.json'), true);
?>
<?php foreach ($filmes as $filme): ?>
  ...
  <div class="movie-container">
    ...
    <div class="item2 ">
          ...
          <img src="images/blue_beetle_ver3_xlg.jpg" alt="Cartaz do Filme">
      </div>
</div>
</div>
...
<div class="texto-centralizado">
      <div class="movie-details">
          ...
          <p>Link trailer:<a href='https://youtu.be/BV5Gp3OEyaM'>https://youtu.be/BV5Gp3OEyaM</p></a>
