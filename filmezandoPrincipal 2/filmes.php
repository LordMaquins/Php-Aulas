...
<div class="row">
    ...
    <div class="item ">
      <a href='pag_film.php'> <img class="arredondado" src="images/guardians_of_the_galaxy_vol_three_ver2.jpg" class="img-fluid"
          alt="Responsive image"> </a> 
          <div class="intro"><p>Guadiões da Galáxia vol.3</p></div>
    ...
    <div class="item ">
      <a href='pag_film.php'><img class="arredondado" src="images/dungeons_and_dragons_honor_among_thieves_ver2_xlg.jpg" class="img-fluid"
          alt="Responsive image"></a>
          <p>Dungeons & Dragons- Honra Entre Rebeldes</p>
      ...
      <div class="item">
        ...
        <a href='pag_film.php'> <img class="arredondado" src="images/demon_slayer_kimetsu_no_yaiba__to_the_swordsmith_village.jpg"
            class="img-fluid" alt="Responsive image"></a>
        <p>Demon Slayer: Para a vila do espadachin</p>
      </div>

      <div class="item">
        <a href='pag_film.php'> <img class="arredondado" src="images/dune_part_two.jpg"
            class="img-fluid" alt="Responsive image"></a>
        <p>Duna 2</p>
      </div>

      <div class="item">
      <a href='pag_film.php'><img class="arredondado" src="images/super_mario_bros_the_movie_ver10.jpg" class="img-fluid"
            alt="Responsive image"></a>
            <p>Super Mario Broos</p>
      </div>

      <div class="item">
        <a href='pag_film.php'> <img class="arredondado" src="images/fastxposter_3955893.jpg"
            class="img-fluid" alt="Responsive image"></a>
      ...
      <div class="item">
      <a href='pag_film.php'><img class="arredondado" src="images/scream_six_ver4_xlg.jpg" class="img-fluid"
            alt="Responsive image"></a>
        <p>Pânico 6</p>
      </div>
      ...
      <div class="item">
      <a href='pag_film.php'> <img class="arredondado" src="images/puss_in_boots_the_last_wish_xlg.jpg" class="img-fluid"
            alt="Responsive image"></a>
            <p>Gato de Botas 2: O Último Pedido</p>
      </div>

      <div class="item">
      <a href='pag_film.php'><img class="arredondado" src="images/evil_dead_rise_xlg.jpg" class="img-fluid"
            alt="Responsive image"></a>
