...
<?php
$filmes = json_decode(file_get_contents('filmes4.json'), true);
?>
<?php foreach ($filmes as $filme): ?>
  ...
  <div class="movie-container">
    ...
    <div class="item2 ">
          ...
          <img src="images/transformers_rise_of_the_beasts_ver11_xlg.jpg" alt="Cartaz do Filme">
      </div>
</div>
</div>
...
<div class="texto-centralizado">
      <div class="movie-details">
          ...
          <p>Link trailer:<a href='https://youtu.be/PHC412-pCoQ'>https://youtu.be/_4is7I_ZxTg</p></a>
